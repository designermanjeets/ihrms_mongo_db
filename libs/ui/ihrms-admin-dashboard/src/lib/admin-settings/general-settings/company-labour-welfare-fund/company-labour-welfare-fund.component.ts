...
@Component({
  selector: 'ihrms-company-labour-welfare-fund',
  templateUrl: './company-labour-welfare-fund.component.html',
  styleUrls: ['./company-labour-welfare-fund.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class CompanyLabourWelfareFundComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    this.controls$ = this._gss.getLabourWelfareFundControls();
  }
