...
@Component({
  selector: 'ihrms-it-declarations',
  templateUrl: './it-declarations.component.html',
  styleUrls: ['./it-declarations.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class ItDeclarationsComponent implements OnInit, AfterViewInit {
